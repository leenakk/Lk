    ...
    return (
        <React.Fragment>
            <div className='flex h-screen z-[1]'>
                ...
                <div className={`fixed top-0 left-0  h-screen bg-rose-700 text-white w-[70vw] sm:w-[35vw] md:w-[30vw] lg:w-[20vw] shadow-2xl py-8 transition-transform duration-300 ease-in-out ${showNavbar ? "translate-x-0" : "-translate-x-full"} sm:translate-x-0`}>
