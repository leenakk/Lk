            ...
            {PostForm &&
                <>
                    ...
                    <div className='flex flex-col justify-center  gap-y-2 fixed left-[50%]  w-[70vw] top-[50%] transition duration-300  sm:w-[50vw]  bg-[white] rounded-lg shadow-lg py-4 px-4' style={{ transform: "translate(-50% , -50%)" }}>
                        ...
                        <textarea name="" rows="5" placeholder='What do you want to sell?' className='p-3' id=""></textarea>
                        <label for="file" class="flex flex-col items-center justify-center w-[300px] h-[200px] gap-5 cursor-pointer border-2 border-dashed border-gray-300 p-6 rounded-lg shadow-[0px_48px_35px_-48px_rgba(232,232,232,0.6)]">
                            <div class="flex items-center justify-center">
                                <svg viewBox="0 0 24 24" class="h-20 fill-gray-300" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="flex items-center justify-center">
                                <span class="font-normal text-gray-300">Click to upload image</span>
                            </div>
